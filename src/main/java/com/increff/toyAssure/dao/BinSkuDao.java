...
public class BinSkuDao extends AbstractDao
{
    ...
    private final static String SELECT_BY_GLOBAL_SKU_ID_AND_BIN_ID = "select p from BinSkuPojo where binId=:binId and globalSkuId=:globalSkuId";

    private final static String SELECT_BY_GLOBAL_SKU_ID = "select p from BinSkuPojo where globalSkuId=:globalSkuId";
